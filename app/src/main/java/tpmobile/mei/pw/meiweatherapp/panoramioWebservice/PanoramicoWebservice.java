package tpmobile.mei.pw.meiweatherapp.panoramioWebservice;
 ...
 */
public class PanoramicoWebservice extends WebserviceConnector{
  ...
  public String doGetImage(String minx, String miny, String maxx, String maxy){
    ...
    String res = postToWebservice(params);
